...
export async function setMainPhoto(photo) {
    ...
    //sprawdzam eventy w których bierze udzial user
    const userFollowingRef = db.collection('following').doc(user.uid).collection('userFollowing');//sprawdzam wszystkich obserwujących
